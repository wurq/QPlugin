...
import static com.arch.pluginarc.PluginManager.EXTRA_CLASS;
import static com.arch.pluginarc.PluginManager.EXTRA_PACKAGE;
...
public class ProxyImpl {
    ...
    public void onCreate(Intent intent) {
        ...
        mPackageName = intent.getStringExtra(EXTRA_PACKAGE);
