...
/**
 * Created by wurongqiu on 2018/4/19.
 */

public class ProxyActivity  extends AppCompatActivity implements Attachable{
    ...
    @Override
    public void attach(IPlugin remoteActivity, PluginManager pluginManager) {
